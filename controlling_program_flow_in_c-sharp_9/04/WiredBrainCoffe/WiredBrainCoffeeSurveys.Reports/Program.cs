...
namespace WiredBrainCoffeeSurveys.Reports
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            GenerateWinnersEmail();
        }

        private static void GenerateWinnersEmail()
        {
        ...
        private static void GenerateCommentsReport()
        {
            ...
            {
                var currentReponse = Q1Results.Responses[i];

                if (currentReponse.WouldRecommend < 7.0)
                {
                    Console.WriteLine(currentReponse.Comments);
                    comments.Add(currentReponse.Comments);
                }
            }
